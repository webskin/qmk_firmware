...
tap_dance_action_t tap_dance_actions[] = {
  ...
  [TD_LESS_LGIL] = ACTION_TAP_DANCE_DOUBLE(BP_LABK, BP_LDAQ),
  [TD_GRTR_RGIL] = ACTION_TAP_DANCE_DOUBLE(BP_RABK, BP_RDAQ),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [MISCR1] = LAYOUT_ergodox_pretty(
    ...
    _______, _______, _______, _______, _______,         _______,              _______,                        KC_AUDIO_VOL_UP,   KC_DELETE,     KC_HOME,       KC_UP,        KC_END,      KC_PSCR,    _______,
    _______, _______, _______, _______, _______,         _______,                                                                 KC_BSPC,       KC_LEFT,       KC_DOWN,      KC_RIGHT,    A(KC_PSCR), _______,
    _______, _______, _______, _______, _______,         TD(TD_PASTE_SINSERT), _______,                        KC_AUDIO_VOL_DOWN, C(KC_BSPC),    C(KC_LEFT),    KC_PGDN,      C(KC_RIGHT), _______,    _______,
  ...
  [MISCR1AZ] = LAYOUT_ergodox_pretty(
    ...
    _______, _______, _______, _______, _______,         _______,              _______,                        KC_AUDIO_VOL_UP,   KC_DELETE,     KC_HOME,       KC_UP,        KC_END,         KC_PSCR,    _______,
    _______, _______, _______, _______, _______,         _______,                                                                 KC_BSPC,       KC_LEFT,       KC_DOWN,      KC_RIGHT,       A(KC_PSCR), _______,
    _______, _______, _______, _______, _______,         TD(TD_PASTE_SINSERT_AZ), _______,                     KC_AUDIO_VOL_DOWN, C(KC_BSPC),    C(KC_LEFT),    KC_PGDN,      C(KC_RIGHT),    _______,    _______,
  ...
  [MISCR2] = LAYOUT_ergodox_pretty(
    ...
    _______, _______, _______, _______, _______,         _______,              _______,                        _______,    KC_DELETE,     S(KC_HOME),    S(KC_UP),      S(KC_END),      KC_PSCR,    _______,
    _______, _______, _______, _______, _______,         _______,                                                          KC_BSPC,       S(KC_LEFT),    S(KC_DOWN),    S(KC_RIGHT),    A(KC_PSCR), _______,
    _______, _______, _______, _______, _______,         TD(TD_PASTE_SINSERT), _______,                        _______,    C(KC_BSPC),    C(S(KC_LEFT)), C(S(KC_DOWN)), C(S(KC_RIGHT)), _______,    _______,
    _______, _______, _______, _______, TD(TD_COPY_CUT),                                                                                  _______,       _______,       _______,        _______,    _______,
                                                                             _______, _______,      _______, _______,
                                                                                      _______,      _______,
  ...
  [MISCR2AZ] = LAYOUT_ergodox_pretty(
    ...
    _______, _______, _______, _______, _______,         _______,              _______,                        _______,    KC_DELETE,    S(KC_HOME),    S(KC_UP),      S(KC_END),      KC_PSCR,    _______,
    _______, _______, _______, _______, _______,         _______,                                                          KC_BSPC,      S(KC_LEFT),    S(KC_DOWN),    S(KC_RIGHT),    A(KC_PSCR), _______,
    _______, _______, _______, _______, _______,         TD(TD_PASTE_SINSERT_AZ), _______,                     _______,    C(KC_BSPC),   C(S(KC_LEFT)), C(S(KC_DOWN)), C(S(KC_RIGHT)), _______,    _______,
    _______, _______, _______, _______, TD(TD_COPY_CUT_AZ),                                                                              _______,       _______,       _______,        _______,    _______,
                                                                             _______, _______,      _______, _______,
                                                                                      _______,      _______,
  ...
  [NUMPAD] = LAYOUT_ergodox_pretty(
    KC_NUM,  _______,      _______, _______,      _______,   _______,      _______,                          _______, _______,      KC_KP_PLUS, KC_KP_MINUS,  KC_KP_SLASH, KC_KP_ASTERISK,  _______,
  ...
  [MOUSE] = LAYOUT_ergodox_pretty(
    ...
    _______, _______, _______, _______, _______, _______, _______,                          _______, KC_MS_WH_DOWN, KC_MS_WH_LEFT, _______,    KC_MS_WH_RIGHT, _______, _______,
    _______, _______, _______, _______, _______,                                                                    _______,    _______,    _______,     _______, _______,
                                                          _______, _______,        _______, _______,
                                                                   _______,        _______,
                                                 _______, _______, _______,        _______, _______, _______
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  if (on_bepo) {
    switch (keycode) {
      ...
      case BP_A:
        if (record->event.pressed && get_highest_layer(layer_state) == MISCR1) {
          SEND_STRING("ea");
          layer_off(MISCR1);
          return false;
        } else {
    ...
    switch (keycode) {
      // Protection de la ligne de repos si on est sur MISCR1
      case FR_A:
        if (record->event.pressed && get_highest_layer(layer_state) == MISCR1AZ) {
